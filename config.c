...
int tiled_margin         =  0;	// Space between windows
int tiled_output_padding =  0;	// Space around windows
float tiled_splitratio   =  0.5;
...
static char *spawn_wmenu[] = {"wmenu-run", "-f", "monospace 15", NULL};
static char *spawn_firefox[] = {"firefox", NULL};

static char *vol_mute[] = SHCMD(
	"$HOME/.config/river/volume_brightness.sh volume_mute");
static char *vol_up[] = SHCMD(
	"$HOME/.config/river/volume_brightness.sh volume_up");
static char *vol_down[] = SHCMD(
	"$HOME/.config/river/volume_brightness.sh volume_down");
static char *powermenu[] = SHCMD(
	"$HOME/.config/river/powermenu");

static char *brightness_up[] = {"brightnessctl", "set", "+5%"};
static char *brightness_down[] = {"brightnessctl", "set", "5%-"};
...
struct Binddef binds[] = {
	...
	{super,       XKB_KEY_j, binding_focus_prev, {0}},
	{super|shift, XKB_KEY_j, binding_move_prev,  {0}},
	{super,       XKB_KEY_k, binding_focus_next, {0}},
	{super|shift, XKB_KEY_k, binding_move_next,  {0}},
...
#define spawn_binding(mod, key, argv)	{mod, key, binding_spawn, {.v = argv}}
	...
	spawn_binding(super, XKB_KEY_p,  spawn_wmenu),
	spawn_binding(super, XKB_KEY_g, spawn_firefox),
	spawn_binding(super|shift, XKB_KEY_e, powermenu),
	spawn_binding(none, XKB_KEY_XF86AudioMute, vol_mute),
	spawn_binding(none, XKB_KEY_XF86AudioRaiseVolume, vol_up),
	spawn_binding(none, XKB_KEY_XF86AudioLowerVolume, vol_down),
	spawn_binding(none, XKB_KEY_XF86MonBrightnessUp, brightness_up),
	spawn_binding(none, XKB_KEY_XF86MonBrightnessDown,brightness_down),
...
struct xkb_rule_names kb_rules = {
	.rules = NULL,
	.model = "pc105",
	.layout = "us",
